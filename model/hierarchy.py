...
class HierarchyModel(BaseModel):
    ...
    def train(self, data) -> None:
        ...
        self.root_model.train(BranchData(data.X_train, data.X_test, data.y2_train, data.y2_test))
        ...
        for y2_value in pd.Series(data.y2_train).unique():
            ...
            for y3_value in pd.Series(branch_y3["train_df"]["y3"]).unique():
    ...
    def print_results(self, data):
        ...
        print(
            ...
            classification_report(data.y2_test, self.pred_y2, zero_division=0),
        )
        print("-------------" * 5, "\n")
        ...
        if valid_y3.any():
            ...
            print(
                "confussion matrix:",
                confusion_matrix(data.y3_test[valid_y3], self.pred_y3[valid_y3]),
            )
            print("-------------" * 5, "\n")
            print(
                "accuracy score:",
                accuracy_score(data.y3_test[valid_y3], self.pred_y3[valid_y3]),
            )
            print("-------------" * 5)
        ...
        if valid_y4.any():
            ...
            print(
                "confussion matrix:",
                confusion_matrix(data.y4_test[valid_y4], self.pred_y4[valid_y4]),
            )
            print("-------------" * 5, "\n")
            print(
                "accuracy score:",
                accuracy_score(data.y4_test[valid_y4], self.pred_y4[valid_y4]),
            )
            print("-------------" * 5)
